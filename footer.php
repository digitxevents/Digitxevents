        ...
        <div class="footer__content">
            ...
            <div class="footer__subscribe">
                <div class="footer__subscribe-description">
                    <h2 class="footer__subscribe-description-title">Newsletter</h2>
                    <h4 class="footer__subscribe-description-heading">Don't miss valuable business insights!</h4>
                    <p class="footer__subscribe-description-text">Subscribe to our Newsletter to receive the latest news and reports</p>
                </div>
                <div class="dxe__subscribe">
                    <form class="row g-3">
                        <div class="col-auto">
                ...
                <div class="social__connect">
                    <span>CONNECT</span> <a href="https://www.facebook.com/digitxnyc/" target="_blank"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.308c0-1.769.931-2.692 3.029-2.692h1.971v3z"/></svg></span></a>
